...
export default function SolutionsPage() {
  ...
  return (
    <div className="bg-[#F8FAFC] font-sans text-slate-900 min-h-screen">
      {/* Hero Header Section */}
      <section className="bg-slate-50 pt-6 pb-12 border-b border-slate-200">
        {/* 🔥 FIXED: Changed max-w-7xl to max-w-[1500px] to match About Us perfectly! */}
            ...
            <div className="md:w-1/2">
              <FadeIn direction="up">
                ...
                <p className="text-slate-500 text-lg leading-relaxed max-w-md">
                  Explore our catalog of advanced industrial automation
                  equipment, custom-built to optimize performance and efficiency
                  on your plant floor.
                </p>
              </FadeIn>
            </div>
      ...
      {/* Main Content */}
      {/* 🔥 FIXED: Changed max-w-7xl to max-w-[1500px] here as well! */}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {filteredMachines.map((machine, index) => (
              <FadeIn key={machine._id} direction="up" delay={index * 0.1}>
                <div className="bg-white h-full rounded-xl overflow-hidden shadow-sm border border-slate-200 flex flex-col group hover:shadow-lg transition-all duration-300">
                  {/* Dynamic Image Box */}
